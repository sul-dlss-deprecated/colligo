...
describe ModsData do
  ...
  let(:document_with_id8) { SolrDocument.new(modsxml: dms_mods_008,
                                            druid: "tw490xj0071",
                                            thumbnail: "https://stacks.stanford.edu/image/iiif/tw490xj0071%2Ftw490xj0071_05_0001/full/!400,400/0/default.jpg") }
  let(:document_with_id11) { SolrDocument.new(modsxml: dms_mods_011,
                                            druid: "rc145sy7436",
  ...
  describe "#mods_to_solr" do
    ...
    it "should have type of resource" do
      ...
      expect(data_with_id["type_of_resource_search"]).to eq(["manuscript", "text"])
    ...
    it "should have publication dates" do
      ...
      expect(data_with_id5["pub_dates"]).to eq(["850", "1499"])
    ...
    it "should have all subjects" do
      ...
      expect(data_with_id11["subject_all_search"]).to eq(["Illuminated manuscripts", "Miniatures (Illuminations)", "Illustrations", "Historiated initials", "Hand coloring"])
    end
