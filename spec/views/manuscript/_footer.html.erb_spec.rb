...
describe '/manuscript/_footer.html.erb' do
  it 'should render the manuscript page footer' do
    ...
    render
    expect(rendered).to have_css('div.col-md-12 span', text: 'Previous record')
    expect(rendered).to have_css('div.col-md-12 span', text: 'Next record')
    expect(rendered).to have_css('div.col-md-12 div.pull-right.footer-top span', text: 'Top')
  end
end
