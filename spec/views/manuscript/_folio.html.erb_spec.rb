...
describe 'manuscript/_folio.html.erb' do
  it 'should render the panel for folio' do
    ...
    expect(rendered).to have_css('div.folio-panel div.panel-heading h3.panel-title span.foliotitle')
    ...
    expect(rendered).to have_css('div.folio-panel div.panel-body div.folio-first-transcription')
  end
end
