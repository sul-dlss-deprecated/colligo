...
describe 'shared/_manuscript_body.html.erb' do
  ...
  it 'should render the manuscript body with author' do
    ...
    expect(rendered).to have_css('div.media div.media-body h4 a[href="/manuscript/hp146pz7537"]', text: 'Gospel Lectionary')
  ...
  it 'should render the manuscript body with thumbnail and truncated abstract' do
    ...
    expect(rendered).to have_css('div.media div.media-body h4 a[href="/manuscript/xs067jx3704"]', text: 'Walters Ms. W.528, Gospel Book')
    expect(rendered).to have_css('div.media div.media-body p', count: 1)
  ...
  it 'should render the manuscript body with all the details' do
    ...
    expect(rendered).to have_css('div.media div.media-body h4 a[href="/manuscript/pc969nh5331"]', text: 'Walters Ms. W.520, Gospel Lectionary')
