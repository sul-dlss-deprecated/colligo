...
describe '/shared/_transcription.html.erb' do
  ...
  describe 'it should render all the transcription data' do
    ...
    it 'should be linked to the id' do
      expect(rendered).to have_css('div.media div.media-body h4.media-heading a[href="/transcriptions/_:N43deaea09a5345379218db8cb72600c3"]')
    end
    it 'should display authors' do
      expect(rendered).to have_css('p', text: 'Joe BloggJohn Smith')
    end
    it 'should display language' do
      expect(rendered).to have_css('p', text: 'Latin')
    end
  ...
  describe 'it should render all available transcription data' do
    before(:each) do
      allow(view).to receive(:document).and_return(transcription_docs[1])
      render
    end
    it 'should have an image' do
    ...
    it 'should be linked to the id' do
      expect(rendered).to have_css('div.media div.media-body h4.media-heading a[href="/transcriptions/_:N14eeb4370547431db7bb7fc075e43210"]')
    end
