...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    #config.add_facet_field 'pub_year_t', :label => 'Publication Year', :single => true
    ...
    #   :years_5 => { :label => 'within 5 Years', :fq => "pub_year_t:[#{Time.now.year - 5 } TO *]" },
    #   :years_10 => { :label => 'within 10 Years', :fq => "pub_year_t:[#{Time.now.year - 10 } TO *]" },
    #   :years_25 => { :label => 'within 25 Years', :fq => "pub_year_t:[#{Time.now.year - 25 } TO *]" }
    #}
